        ...
        <>
          <View style={styles.lastWrapper}>
            ...
            <View style={styles.lastDescripWrapper}>
              <Text style={[styles.description, styles[`description${theme}`]]}>
                Prohibitory road signs in Malaysia are used on all road types in
                Malaysia.
                {"\n"}
                Often to restrict certain types of vehicles and certain
                manoeuvres such as prohibiting u-turns or setting maximum
                speeds.
              </Text>
            </View>
          </View>
