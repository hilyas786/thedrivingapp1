...
export default function myLearnChoice({ navigation }) {
  ...
  const handleWarning = () => {
    navigation.navigate("myLearnWarningSign");
  };

  const handleProhib = () => {
    navigation.navigate("myLearnProhib");
  };
  const handleInfo = () => {
    navigation.navigate("myLearnInfo");
  };
