...
import engLearnProhibData from "../../../data/engLearnData/engLearnProhibData";
import {
  Lato_100Thin,
  Lato_100Thin_Italic,
  Lato_300Light,
...
export default function myLearnProhib({ navigation }) {
  const [currentQuestion, setCurrentQuestion] = useState(0);
  const [disabled, setDisabled] = useState(false);
  const { theme } = useContext(ThemeContext);
  const data = engLearnProhibData;
      ...
      {disabled && (
        <>
          <View style={styles.lastWrapper}>
            <View style={styles.imageWrapper}>
              <Image
                source={require("../../../assets/images/prohibSigns/noparking.png")}
            ...
            <View style={styles.lastDescripWrapper}>
              <Text style={[styles.description, styles[`description${theme}`]]}>
                Papan tanda jalan larangan di Malaysia digunakan pada semua
                jenis jalan di Malaysia.
                {"\n"}
                Selalunya untuk menyekat jenis kenderaan yang tertentu seperti
                gerakan melarang pusingan-u atau menetapkan maksimum kelajuan.
              </Text>
            </View>
          </View>
          <View style={styles.button2}>
